...
public class DeleteGame {
    private JFrame del;
    private static final Logger log = Logger.getLogger(DeleteGame.class);
    public void show(EntityManager em){
        ...
        List idg=em.createQuery("Select id From Game p ").getResultList();
        JButton but=new JButton("Delete");
        but.addActionListener(e -> {
            try {
                new CheckTable().CheckId(id.getText(),idg,"");
                ...
                if (n==0) {
                    ...
                    em.remove(em.find(Game.class, Integer.parseInt(id.getText())));
