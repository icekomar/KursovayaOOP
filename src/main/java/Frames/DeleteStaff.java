...
public class DeleteStaff {
    private JFrame del;
    private static final Logger log = Logger.getLogger(DeleteStaff.class);
    public void show(EntityManager em){
        ...
        List ids=em.createQuery("Select id From Staff p ").getResultList();
        JButton but=new JButton("Delete");
        but.addActionListener(e -> {
            try {
                new CheckTable().CheckId(id.getText(),ids,"");
                ...
                if (n==0) {
                    ...
                    em.remove(em.find(Staff.class, Integer.parseInt(id.getText())));
